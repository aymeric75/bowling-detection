...
nbr_frame_to_skip = 45 # nber of frames to skip after Inference made
nbr_frame_before_inference = 10 # nber of frames to skip btween boule detection and inference
